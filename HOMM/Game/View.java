...
public class View {
    ...
    public static void view() {
        ...
        step++;
        Field.initiativeScale.forEach((v) -> l[0] = Math.max(l[0], v.getInfo().length()));
        ...
        System.out.print("|    ");
        System.out.print(Field.red.get(0).getInfo());
        tabSetter(Field.red.get(0).getInfo().length(), l[0]);
        System.out.println(Field.blue.get(0).getInfo());
        ...
        for (int i = 2; i < 10; i++) {
            ...
            System.out.print("|    ");
            System.out.print(Field.red.get(i - 1).getInfo());
            tabSetter(Field.red.get(i - 1).getInfo().length(), l[0]);
            System.out.println(Field.blue.get(i - 1).getInfo());
            System.out.println(midl10);
        }
        for (int j = 1; j < 11; j++) {
        ...
        System.out.print("|    ");
        System.out.print(Field.red.get(9).getInfo());
        tabSetter(Field.red.get(9).getInfo().length(), l[0]);
        System.out.println(Field.blue.get(9).getInfo());
